...
**Version**: 1.3.0 (Refresh Product Type System)
...
**리프레시 제품 유형 시스템 추가** ✅
- 제품 컨셉 선택: 증상케어 (타사 공방) vs 리프레시 (자사 브랜드)
- 리프레시 제품 유형 6가지:
  - ✨ 섬유 향수 (현재 제조 중) - 등록 완료
  - ✨ 룸 스프레이 (현재 제조 중) - 등록 완료
  - ⏳ 섬유 탈취제 (준비 중)
  - ⏳ 디퓨저 (준비 중)
  - ⏳ 캔들 (준비 중)
  - ⏳ 향수 (준비 중)
- 제품 카드에 컨셉 뱃지 표시 (증상케어/리프레시)
- 리프레시 제품 유형별 아이콘 표시
- 리프레시 제품은 공방 정보 입력 불필요
- Migration: `0009_add_refresh_product_type.sql` 적용됨

**이전 업데이트 (v1.2.0)** - 로컬 공방 정보 시스템 (증상케어 제품용)
